...
total_rankers = 10
team_skaters = 29 #num in Luna's version - number of skaters on the team we're running
num_std_devs = 1 #factor in Luna's version - number of std deviations to define which points to keep/toss
directory = "rawDataDraftable/"
team = "db" #set the team to choose your input files
...
if __name__ == "__main__":
	...
	while i <= team_skaters:
		...
		filename = "outliers2015/" + directory + team + str(i) + ".csv"
